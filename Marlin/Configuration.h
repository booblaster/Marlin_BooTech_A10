...
#define STRING_CONFIG_H_AUTHOR "(booblaster)" // Who made the changes.
...
#define LIMITED_MAX_FR_EDITING        // Limit edit via M203 or LCD to DEFAULT_MAX_FEEDRATE * 2
  ...
  #define MAX_FEEDRATE_EDIT_VALUES    { 400, 400, 60, 40 } // ...or, set your own edit limits
#endif
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -38, 0, -2.10 }
...
#define LCD_BED_TRAMMING
  ...
  #define BED_TRAMMING_INSET_LFRB { 30, 40, 30, 40 } // (mm) Left, Front, Right, Back insets
...
//  #define Z_SAFE_HOMING_Y_POINT Y_CENTER  // Y point for Z homing
  #define Z_SAFE_HOMING_X_POINT 3.0   // X point for Z homing
  #define Z_SAFE_HOMING_Y_POINT 40.0  // Y point for Z homing
#endif
